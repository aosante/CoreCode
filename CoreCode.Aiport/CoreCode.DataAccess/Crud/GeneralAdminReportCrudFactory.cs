...
{
    public class GeneralAdminReportCrudFactory : CrudFactory
    {
        ...
        public readonly GeneralAdminReportMapper GeneralReportMapperInstance;
        public readonly AirlineMapper AirlineMapperInstance;
        public readonly AirportMapper AirportMapperInstance;
        public GeneralAdminReportCrudFactory()
        {
            GeneralReportMapperInstance = new GeneralAdminReportMapper();
