function vFlight() {
    ...
    this.BuyTicket = function () {
        ...
        if (document.getElementById("txtId").value == "") {
            ...
            swal({
                title: "¡Ocurrió un error!",
                text: "Seleccione un vuelo a comprar",
                icon: "error",
                button: "OK",
            });
        }
        else {
            localStorage.setItem('originAirportLS', document.querySelector("#dropdownOriginAirport").value);
            localStorage.setItem('destinyAirportLS', document.querySelector("#dropdownDestinyAirport").value);

            swal({
                title: "¡Acción realizada con éxito!",
                text: "Será dirigido a su compra de tiquete",
                icon: "success",
                button: "OK"
            }).then(function () {
...
$(document).ready(function () {
    ...
    document.querySelector("#txtId").disabled = true;
     document.querySelector("#dropdownOriginAirport").disabled=true;
     document.querySelector("#dropdownDestinyAirport").disabled=true;
